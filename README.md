...
An open source Python 3.9 tool to scrape all publicly listed servers from various server lists, ping them to collect data, and save the results into a database.
